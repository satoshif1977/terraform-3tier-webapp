...
- 面接課題を通じて、インフラ構築から運用設計までの一連の流れを習得する
...
| シーン | 内容 |
|--------|------|
| 面接・副業ポートフォリオ | 実デプロイ済みの AWS 構成として提示 |
...
| CloudWatch アラーム | CPU・ALB 5xx・RDS 監視 + SNS 通知（次のポートフォリオで実装予定） |
...
```bash
git clone https://github.com/satoshif1977/interview-challenge.git
